...
double  Baxter_IK_solver::precise_soln_q123(Eigen::Affine3d const& desired_tool_pose,Vectorq7x1 q123_approx, Vectorq7x1 &q123_precise) {
        double q_s0 = q123_approx[0];
        Eigen::Affine3d desired_flange_pose = Affine_torso_to_rarm_mount_.inverse()*A_tool_wrt_flange_.inverse()*desired_tool_pose;
