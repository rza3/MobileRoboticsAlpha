...
void jointStatesCb(const sensor_msgs::JointState& js_msg) {
    ...
    if (right_arm_joint_indices_.size()<1) {
       ...
       // cout<<"CB: q_vec_right_arm: "<<q_vec_right_arm_Xd_.transpose()<<endl;       
        cout<<"CB: q_vec_left_arm: "<<q_vec_left_arm_Xd_.transpose()<<endl;       
...
//    A4x4a = A_torso_to_rarm_mount*(baxter_fwd_solver.fwd_kin_solve_(q_vec_right_arm_))*A4x4_tool_wrt_flange;
      A4x4a = A_torso_to_rarm_mount*(baxter_fwd_solver.fwd_kin_solve_(q_vec_left_arm_))*A4x4_tool_wrt_flange;
  ...
  //  Jacobian = baxter_fwd_solver.compute_Jacobian(q_vec_right_arm_);
    Jacobian = baxter_fwd_solver.compute_Jacobian(q_vec_left_arm_);
    
   // A4x4b = A_torso_to_rarm_mount*(baxter_fwd_solver.fwd_kin_solve_(q_vec_right_arm_+dq))*A4x4_tool_wrt_flange;
    A4x4b = A_torso_to_rarm_mount*(baxter_fwd_solver.fwd_kin_solve_(q_vec_left_arm_+dq))*A4x4_tool_wrt_flange;
    ...
    cout<<"left arm angles: "<<q_vec_left_arm_.transpose()<<endl;
 ...
 //   fwd_kin_tool_wrt_torso=baxter_fwd_solver.fwd_kin_tool_wrt_torso_solve(q_vec_right_arm_);
    fwd_kin_tool_wrt_torso=baxter_fwd_solver.fwd_kin_tool_wrt_torso_solve(q_vec_left_arm_);
    ...
    fwd_kin_tool_wrt_torso=baxter_fwd_solver.fwd_kin_tool_wrt_torso_solve(q_vec_left_arm_+dq);
